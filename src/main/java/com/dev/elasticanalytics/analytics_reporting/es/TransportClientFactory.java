...
public class TransportClientFactory implements FactoryBean<TransportClient>, InitializingBean, DisposableBean {
   ...
   // private static final Logger logger = LoggerFactory.getLogger(TransportClientFactory.class);
    ...
    protected void buildClient() throws Exception {
        ...
        client = new PreBuiltTransportClient(Settings.EMPTY).addTransportAddress(new TransportAddress(InetAddress.getByName(clusterNodes), 9300));
...
//        }
    ...
    private Settings settings() {
        /*if (properties != null) {
        	...
        	return Settings.builder().put(properties)
